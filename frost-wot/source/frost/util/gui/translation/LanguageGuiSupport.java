...
public class LanguageGuiSupport {
    ...
    private LanguageGuiSupport() {
        ...
        languageBulgarianMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_bg.png", 16, 16));
        languageGermanMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_de.png", 16, 16));
        languageEnglishMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_en.png", 16, 16));
        languageSpanishMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_es.png", 16, 16));
        languageFrenchMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_fr.png", 16, 16));
        languageItalianMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_it.png", 16, 16));
        languageJapaneseMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_ja.png", 16, 16));
        languageDanishMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_da.png", 16, 16));
        languageDutchMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_nl.png", 16, 16));
        languageRussianMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_ru.png", 16, 16));
        languagePolishMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_pl.png", 16, 16));
        languageSwedishMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_sv.png", 16, 16));
        languageEsperantoMenuItem.setIcon(MiscToolkit.getScaledImage("/data/flags/flag_eo.png", 16, 16));
