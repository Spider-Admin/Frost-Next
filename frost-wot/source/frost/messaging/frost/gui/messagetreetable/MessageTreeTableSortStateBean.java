...
public class MessageTreeTableSortStateBean {
            ...
            implements Comparator<FrostMessageObject>
    {
         ...
         */
        public int compare(
                final FrostMessageObject msg1,
                final FrostMessageObject msg2)
        {
            ...
            switch( fType.getObjType() ) {
                case 0: // "String"
                    ...
                    switch( fType ) {
                        case SUBJECT:
                            s1 = msg1.getSubject(); s2 = msg2.getSubject();
                            ...
                            break;
                        case FROM:
                            s1 = msg1.getFromName(); s2 = msg2.getFromName();
                            break;
                ...
                case 2: // "long"
                    ...
                    switch( fType ) {
                        case DATE:
                            l1 = msg1.getDateAndTime().getMillis(); l2 = msg2.getDateAndTime().getMillis();
                            break;
                    }
                ...
                case 3: // "int"
                    ...
                    switch( fType ) {
                        case INDEX:
                            i1 = msg1.getIndex(); i2 = msg2.getIndex();
                            break;
                    }
            ...
            if( result == 0 && fType != Type.DATE ) {
                ...
                return Mixed.compareLong(msg1.getDateAndTime().getMillis(), msg2.getDateAndTime().getMillis());
            } else {
